...
it('binary utils - bufferConcat', () => {
  ...
  const x2 = binUtils.bufferConcat(
...
it('binary utils - pqPrimeFactorization', () => {
  const res = binUtils.pqPrimeFactorization([
    0x17,
    0xed,
    0x48,
    0x94,
